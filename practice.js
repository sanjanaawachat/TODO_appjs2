...
const popup = document.querySelector(".pop_up_box");
...
addList.addEventListener("click", () => {
 ...
 document.querySelector(".big_container").classList.add("blur");
 ...
 addBtn.addEventListener("click", () => {
   if (popInput.value=== "") {
     ...
     document.getElementById("title_heading").style.display="none";//no items in the list
     ...
     boxHeading.addEventListener('click',()=>{
       ...
       deleteBtn.addEventListener('click',()=>{
         ...
         document.querySelector(".big_container").style.visibility="visible";
     ...
     document.querySelector(".big_container").classList.remove("blur");//blur will dissapear
     deleteBtn.addEventListener("click", () => {//deletin the whole card
       ...
       if(document.querySelector(".container-2").innerText===""){
         document.querySelector("#title_heading").style.display="block";
       }
     });
     ...
     add.addEventListener("click", () => {
       ...
       //if user write items name as input-
         if (popInput.value !== "") {
           ...
           document.querySelector(".big_container").classList.remove("blur");
